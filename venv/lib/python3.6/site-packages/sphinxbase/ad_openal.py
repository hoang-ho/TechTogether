...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_ad_openal')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_ad_openal')
    _ad_openal = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ad_openal', [dirname(__file__)])
        except ImportError:
            import _ad_openal
            return _ad_openal
        try:
            _mod = imp.load_module('_ad_openal', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class Ad(object):
    ...
    def __init__(self, audio_device=None, sampling_rate=16000):
        ...
        this = _ad_openal.new_Ad(audio_device, sampling_rate)
        try:
...
Ad_swigregister = _ad_openal.Ad_swigregister
Ad_swigregister(Ad)
